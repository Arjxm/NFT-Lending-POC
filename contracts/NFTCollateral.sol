...
contract NFTCollateral is IERC721Receiver {
     ...
     */
        function _depositNFT(address nftAddress, uint256 tokenId) internal returns (uint256) {
        ...
        // Calculate the amount based on NFT balance and multiply by 10
        uint256 nftBalance = IERC721(nftAddress).balanceOf(address(this));
        uint256 amount = nftBalance * 5000000000000000000;
